...
const session: AuthSession = {
  ...
  user: { id: "user-id", app_metadata: {}, user_metadata: {}, aud: "authenticated", created_at: "2026-09-17T00:00:00Z" },
};
...
function setup() {
  ...
  return { resolve, reject, pending, onChange, unsubscribe, stop, emit: (next: AuthSession | null) => callback(next ? "SIGNED_IN" : "SIGNED_OUT", next) };
}
